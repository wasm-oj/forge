...
async function main() {
  ...
  if (options.check) {
    ...
    try {
      ...
      fail("src/judge/problems.generated.ts is missing; run pnpm problems:generate");
    }
    if (current !== output) {
      fail("src/judge/problems.generated.ts is stale; run pnpm problems:generate");
    }
    console.log("verified generated Forge catalog for 40 localized problems");
    return;
  }
  ...
  console.log("generated Forge catalog for 40 localized problems");
}
