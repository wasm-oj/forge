...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| C / wasip1 | `b195a678…f952b` | 45,625 | 5,445 / 5,591 / 146 | 1,778 ms / 1,774 ms | 1,252 ms / 1 ms | 34 ms / 9 ms |
| C / wasip1 / filesystem metadata | `856e2fe9…c013e` | 33,056 | 15,427 / 15,573 / 146 | 1,853 ms / 1,585 ms | 204 ms / 1 ms | 28 ms / 6 ms |
| C / wasip1 / multi-file IO | `334dab5d…3bf97` | 49,908 | 16,883 / 17,029 / 146 | 1,820 ms / 1,791 ms | 189 ms / 765 ms | 31 ms / 9 ms |
| C / wasip1 / filesystem write limit | `b3d8825f…4f79a` | 18,945 | 6,219 / 6,365 / 146 | 1,728 ms / 1,756 ms | 364 ms / 1 ms | 18 ms / 3 ms |
| C / WASIX | `c3928999…8cd19` | 4,064 | 1,138 / 1,284 / 146 | 1,745 ms / 1,771 ms | 357 ms / 1 ms | 9 ms / 1 ms |
| C / WASIX / denied thread_spawn | `432af0c8…210a7` | 1,072 | 0 / 133 / 146 | 1,728 ms / 1,707 ms | 181 ms / 763 ms | 7 ms / 1 ms |
| C++ / wasip1 | `db897e4f…bb50d` | 4,059 | 934 / 1,080 / 146 | 1,833 ms / 1,870 ms | 579 ms / 1 ms | 10 ms / 1 ms |
| C++ / WASIX | `e5f96539…40e11` | 4,059 | 934 / 1,080 / 146 | 1,793 ms / 1,840 ms | 102 ms / 1 ms | 9 ms / 1 ms |
| Rust / wasip1 | `05fcf6e0…6fac0` | 142,818 | 14,761 / 24,243 / 9,482 | 3,062 ms / 3,090 ms | 2,702 ms / 587 ms | 37 ms / 13 ms |
| Python / wasip1 | `98561f95…ac712` | 1,851 | 4,632,241 / 2,424,466,250 / 2,419,834,009 | 16,372 ms / 16,378 ms | 1,452 ms / 441 ms | 1,082 ms / 775 ms |
| JavaScript / wasip1 | `673f1db6…927a7` | 1,902 | 4,489,846 / 14,074,831 / 9,584,985 | 2,269 ms / 1,841 ms | 1,606 ms / 2,056 ms | 234 ms / 163 ms |
| TypeScript / wasip1 | `8cc8d4b3…83ae4` | 1,925 | 4,514,568 / 14,099,553 / 9,584,985 | 1,842 ms / 1,854 ms | 1,600 ms / 1,905 ms | 229 ms / 163 ms |
| Go / wasip1 | `39d6cb9e…596fb` | 2,550,145 | 429,396 / 2,136,517 / 1,707,121 | 3,152 ms / 2,692 ms | 1,667 ms / 408 ms | 374 ms / 275 ms |
| C / wasip1 / virtual clock | `f72e1525…dc27b` | 18,565 | 8,022 / 8,168 / 146 | 1,825 ms / 1,869 ms | 1,121 ms / 1 ms | 19 ms / 3 ms |
| C / wasip1 / logical time limit | `feae5bbd…e648d` | 1,254 | 51 / 197 / 146 | 1,834 ms / 1,818 ms | 349 ms / 1 ms | 6 ms / 0 ms |
| C++ / wasip1 / virtual sleep | `7ef531ef…2cba1` | 23,327 | 4,985 / 5,131 / 146 | 1,917 ms / 1,582 ms | 232 ms / 739 ms | 21 ms / 4 ms |
| Rust / wasip1 / virtual sleep | `28b9dca7…7e74d` | 168,053 | 16,640 / 26,122 / 9,482 | 2,973 ms / 2,952 ms | 2,603 ms / 560 ms | 40 ms / 14 ms |
| Python / wasip1 / virtual sleep | `3b6e2b1c…5830b` | 2,041 | 4,648,726 / 2,424,482,735 / 2,419,834,009 | 16,392 ms / 16,396 ms | 1,475 ms / 464 ms | 1,033 ms / 790 ms |
| JavaScript / wasip1 / virtual clock | `77fedb77…d488f` | 1,948 | 28,374,535 / 37,959,520 / 9,584,985 | 1,790 ms / 1,829 ms | 1,511 ms / 1,506 ms | 229 ms / 166 ms |
| TypeScript / wasip1 / virtual clock | `3cd0cb23…bcab5` | 1,948 | 28,374,535 / 37,959,520 / 9,584,985 | 2,129 ms / 2,095 ms | 1,806 ms / 1,823 ms | 227 ms / 166 ms |
| Go / wasip1 / virtual sleep | `8a7e09d7…3c07f` | 2,561,512 | 589,026 / 2,296,147 / 1,707,121 | 2,547 ms / 2,538 ms | 885 ms / 407 ms | 378 ms / 276 ms |
