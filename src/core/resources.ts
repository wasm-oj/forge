...
export function resolveResourcePolicy(value: Partial<ResourcePolicy> | undefined): ResourcePolicy {
  ...
  assertSafePositive("memoryLimitBytes", policy.memoryLimitBytes, 4 * 1024 * 1024 * 1024);
  ...
  assertSafePositive("wallTimeLimitMs", policy.wallTimeLimitMs, 10 * 60 * 1_000);
  if (policy.memoryLimitBytes % 65_536 !== 0) {
