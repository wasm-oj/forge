...
export interface CatalogProblem {
  ...
  readonly track: Record<string, string>;
...
export const copy = {
  en: {
    greeting: "Welcome to Forge", subtitle: "Practice programming in your browser, then submit for a verified result when you are ready.",
    start: "Start official practice", official: "Official practice", officialNote: "Curated problems maintained by Forge.",
    ...
    catalog: "Problems", catalogIntro: "Browse published practice problems. Open a problem only when you are ready to code.",
    search: "Search by title, number, or tag…", difficulty: "All difficulties", topic: "All topics", status: "All status",
  ...
  "zh-TW": {
    greeting: "歡迎來到 Forge", subtitle: "先在瀏覽器練習程式設計，準備好後再正式提交取得驗證結果。",
    start: "開始官方練習", official: "官方題庫", officialNote: "由 Forge 維護的精選練習題。",
    progress: "你的進度", solved: "題已完成", continue: "繼續學習", noDraft: "選一題開始。你的程式碼會留在這個瀏覽器。",
    contests: "競賽", upcoming: "進行中與即將開始的競賽", recent: "最近提交", all: "查看全部",
    catalog: "題庫", catalogIntro: "瀏覽已發布的練習題，選好題目後才進入程式編輯器。",
    search: "搜尋標題、題號或標籤…", difficulty: "所有難度", topic: "所有主題", status: "所有狀態",
...
export function useCatalog() {
  ...
  useEffect(() => {
    ...
    void forgeJson<{ collections: readonly CatalogCollection[] }>("/api/problems", { signal: controller.signal })
      .then((value) => setCollections(value.collections))
